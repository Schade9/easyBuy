               ...
               <div class="row clearfix">
                     ...
                     <div class="col-lg-3 col-sm-6 col-md-3">
                        <a href="productpage.html">
                           <div class="box-img">
                              ...
                              {{-- <img src="/images/categoryimages/{{ $category->imgpath }}'" alt="" /> --}}
                              <img src="{{ url('images/'.$category->imgpath) }}" alt="img" />
                           </div>
                        </a>
                     </div>
                  @endforeach
                  ...
                  <div class="col-lg-3 col-sm-6 col-md-3">
                     <a href="productpage.html">
                        <div class="box-img">
                           <h4>Product</h4>
                           <img src="static/images/product/2.png" alt="" />
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                     <a href="productpage.html">
                        <div class="box-img">
                           <h4>Product</h4>
                           <img src="static/images/product/4.png" alt="" />
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                     <a href="productpage.html">
                        <div class="box-img">
                           <h4>Product</h4>
                           <img src="static/images/product/5.png" alt="" />
                        </div>
                     </a>
                  </div>
            ...
            <div class="product-slidr">
               <div class="slider">
                  <div>
                     <div class="prod-box">
                        <div class="prod-i">
                           <img src="static/images/tr1.png" alt="#" />
                        </div>
                  ...
                  <div>
                     <div class="prod-box">
                        <div class="prod-i">
                           <img src="static/images/tr2.png" alt="#" />
                        </div>
                        <div class="prod-dit clearfix">
                           <div class="dit-t clearfix">
                              <div class="left-ti">
                  ...
                  <div>
                     <div class="prod-box">
                        <div class="prod-i">
                           <img src="static/images/tr3.png" alt="#" />
                        </div>
                        <div class="prod-dit clearfix">
                           <div class="dit-t clearfix">
                              <div class="left-ti">
                  ...
                  <div>
                     <div class="prod-box">
                        <div class="prod-i">
                           <img src="static/images/tr4.png" alt="#" />
                        </div>
                        <div class="prod-dit clearfix">
                           <div class="dit-t clearfix">
                              <div class="left-ti">
